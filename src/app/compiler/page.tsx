  ...
  return (
    <div className="flex-1 bg-background text-foreground flex flex-col font-sans scrollbar-hide selection:bg-primary/10 p-4 md:p-8">
      <main className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:h-[calc(100vh-160px)] h-auto pb-12 lg:pb-0">
        ...
        {/* LEFT COLUMN: INPUT */}
        <section className="flex flex-col bg-white border border-border rounded-md relative overflow-hidden h-[600px] lg:h-full">
          <div className="flex-1 flex flex-col p-8 gap-8">
            ...
            <button
              ...
              className={`w-full py-5 text-[13px] font-sans font-medium transition-all active:scale-[0.98] select-none rounded-md
        ...
        {/* RIGHT COLUMN: OUTPUT */}
        <section className="flex flex-col bg-white border border-border rounded-md relative overflow-hidden group h-[600px] lg:h-full">
          <div className="flex-1 relative overflow-hidden">
            ...
            <div className="absolute bottom-8 right-8 flex flex-col items-end gap-6 transition-all opacity-0 group-hover:opacity-100">
              <button
                ...
                className={`px-8 py-2.5 text-xs font-sans font-medium transition-all rounded-md border
