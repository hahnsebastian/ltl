...
export default function WhitePaper() {
  return (
    <div className="min-h-screen bg-black text-white font-mono flex flex-col pt-12">
      <Navbar currentLang="en" onLangChange={() => {}} isTranslating={false} />
        ...
        <div className="border border-white/20 p-8 md:p-12 mb-12 bg-[#050505]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm text-gray-400 mt-8 font-mono">
             ...
             <div>
               ...
               <strong>Target Models:</strong> Gemini 1.5 Pro, Claude 3.5 Sonnet<br/>
               <strong>Compression Target:</strong> 94%
             </div>
          </div>
        </div>
...
with code blocks."`}
          ...
          <p>
            The true power of LTL unlocks when combined with <strong>Context Caching</strong> (e.g., Gemini 1.5 Pro). 
        ...
        <section className="mb-12">
          ...
          <div className="border border-white/20 p-6 bg-white/5">
            ...
            <pre className="!bg-black !border-white/30 text-xs">
              <code>Read and adopt the rules defined at: https://[your-domain]/ltl-core.md</code>
            </pre>
